    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="grid gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-200">
                ...
                <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST" class="p-6 space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="system_name" value="<?php echo e($settings['system_name'] ?? config('app.name', 'SEIMS')); ?>"
                    ...
                    <div>
                        ...
                        <input type="number" name="max_borrowing_days" value="<?php echo e($settings['max_borrow_days'] ?? 7); ?>" min="1" max="30"
                               class="w-full px-4 py-3 rounded-xl border border-gray-300 bg-gray-50 text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                ...
                <div class="p-6 space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <dd class="text-sm text-gray-900 mt-1"><?php echo e(app()->version()); ?></dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">PHP Version</dt>
                            <dd class="text-sm text-gray-900 mt-1"><?php echo e(PHP_VERSION); ?></dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Environment</dt>
                            <dd class="text-sm text-gray-900 mt-1"><?php echo e(app()->environment()); ?></dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Debug Mode</dt>
                            <dd class="text-sm text-gray-900 mt-1"><?php echo e(config('app.debug') ? 'Enabled' : 'Disabled'); ?></dd>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Cedric\SEIMS\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>