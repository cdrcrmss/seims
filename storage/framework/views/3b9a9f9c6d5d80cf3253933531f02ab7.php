...
<div class="space-y-8">
    ...
    <div class="flex flex-wrap gap-3 animate-fade-in-up stagger-1">
        ...
        <a href="<?php echo e(route('analytics.procurement')); ?>" class="px-4 py-2 bg-white ring-1 ring-gray-200 rounded-xl text-sm font-semibold text-gray-700 hover:bg-green-50 hover:text-green-700 hover:ring-green-200 transition-all">
            🛒 Procurement
        </a>
    </div>
