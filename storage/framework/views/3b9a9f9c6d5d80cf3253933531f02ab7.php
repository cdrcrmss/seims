...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 animate-fade-in-up stagger-2">
        <a href="<?php echo e(route('staff.items.index')); ?>" class="bg-white rounded-2xl ring-1 ring-gray-200 p-6 border-l-4 border-green-500 hover:ring-green-300 transition-all cursor-pointer block">
        ...
        <a href="<?php echo e(route('staff.items.index', ['status' => 'out_of_stock'])); ?>" class="bg-white rounded-2xl ring-1 ring-gray-200 p-6 border-l-4 border-red-500 hover:ring-red-300 transition-all cursor-pointer block">
        ...
        <a href="<?php echo e(route('maintenance.dashboard')); ?>" class="bg-white rounded-2xl ring-1 ring-gray-200 p-6 border-l-4 border-orange-500 hover:ring-orange-300 transition-all cursor-pointer block">
        ...
        <a href="<?php echo e(route('reservations.index')); ?>" class="bg-white rounded-2xl ring-1 ring-gray-200 p-6 border-l-4 border-blue-500 hover:ring-blue-300 transition-all cursor-pointer block">
