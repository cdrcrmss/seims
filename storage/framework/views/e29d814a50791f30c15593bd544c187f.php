...
<head>
    ...
    <title>Sign In - <?php echo e(config('app.name', 'SEIMS')); ?></title>
        ...
        <div class="brand-panel" style="flex: 1; display: flex; flex-direction: column; justify-content: center; padding: 48px; position: relative;">
            ...
            <div style="position: relative; z-index: 10; max-width: 480px;">
                ...
                <div class="animate-slide-in" style="display: flex; align-items: center; gap: 16px; margin-bottom: 48px;">
                    <div class="animate-float" style="width: 56px; height: 56px; background: linear-gradient(135deg, #16a34a, #22c55e); border-radius: 16px; display: flex; align-items: center; justify-content: center;">
                        <img src="<?php echo e(asset('images/spup_logo.png')); ?>" alt="SPUP Logo" style="width: 48px; height: 48px; object-fit: contain;">
                    </div>
                    <div>
                ...
                <div class="animate-fade-in-up delay-200">
                    <div class="feature-item">
                        ...
                        <div>
                            <h3 style="font-size: 16px; font-weight: 600; color: white; margin: 0 0 4px 0;">Real-Time Tracking</h3>
                            <p style="font-size: 14px; color: rgba(255,255,255,0.6); margin: 0; line-height: 1.5;">Monitor equipment usage and availability instantly</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-item">
                        ...
                        <div>
                            <h3 style="font-size: 16px; font-weight: 600; color: white; margin: 0 0 4px 0;">Secure & Reliable</h3>
                            <p style="font-size: 14px; color: rgba(255,255,255,0.6); margin: 0; line-height: 1.5;">Enterprise-grade security for your sensitive data</p>
                        </div>
                    </div>
                    ...
                    <div class="feature-item">
                        ...
                        <div>
                            <h3 style="font-size: 16px; font-weight: 600; color: white; margin: 0 0 4px 0;">Smart Analytics</h3>
                            <p style="font-size: 14px; color: rgba(255,255,255,0.6); margin: 0; line-height: 1.5;">Insights and reports to optimize resource allocation</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="animate-fade-in delay-400" style="position: absolute; bottom: 48px; left: 48px; right: 48px;">
                <p style="font-size: 14px; color: rgba(255,255,255,0.4); margin: 0;">
                    © <?php echo e(date('Y')); ?> SEIMS. All rights reserved.
                </p>
            </div>
        </div>
            ...
            <div style="width: 100%; max-width: 420px;" class="animate-fade-in-up">
                ...
                <div style="display: none; text-align: center; margin-bottom: 40px;" class="mobile-logo">
                    <div style="width: 64px; height: 64px; background: linear-gradient(135deg, #16a34a, #22c55e); border-radius: 16px; display: inline-flex; align-items: center; justify-content: center; margin-bottom: 16px;">
                        <img src="<?php echo e(asset('images/spup_logo.png')); ?>" alt="SPUP Logo" style="width: 56px; height: 56px; object-fit: contain;">
                    </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 28px;">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" style="font-size: 14px; color: #16a34a; text-decoration: none; font-weight: 500; transition: color 0.2s;" onmouseover="this.style.color='#15803d'" onmouseout="this.style.color='#16a34a'">
                                Forgot password?
                            </a>
                        <?php endif; ?>
                    </div>
                ...
                <div style="text-align: center; margin-bottom: 24px;">
                    <p style="font-size: 14px; color: #64748b; margin: 0;">
                        ...
                        <a href="<?php echo e(route('register')); ?>" style="color: #16a34a; text-decoration: none; font-weight: 600; transition: color 0.2s;" onmouseover="this.style.color='#15803d'" onmouseout="this.style.color='#16a34a'">
                            Create Account
                        </a>
                    </p>
                </div>
...
<?php /**PATH C:\Users\Cedric\SEIMS\resources\views/auth/login.blade.php ENDPATH**/ ?>