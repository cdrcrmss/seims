...
<head>
    ...
    <title>Create Account - <?php echo e(config('app.name', 'SEIMS')); ?></title>
    ...
    <div style="display: flex; min-height: 100vh;">
        ...
        <div class="brand-panel" style="flex: 1; display: flex; flex-direction: column; justify-content: center; padding: 48px; position: relative;">
            ...
            <div class="animate-fade-in delay-400" style="position: absolute; bottom: 48px; left: 48px; right: 48px;">
                <p style="font-size: 14px; color: rgba(255,255,255,0.4); margin: 0;">
                    &copy; <?php echo e(date('Y')); ?> SEIMS. All rights reserved.
                </p>
            </div>
        </div>
        ...
        <div style="flex: 1; display: flex; align-items: center; justify-content: center; padding: 48px; background: #f8fafc;">
            <div style="width: 100%; max-width: 420px;" class="animate-fade-in-up">
                ...
                <!-- Registration Form -->
                <form method="POST" action="<?php echo e(route('register')); ?>" x-data="{ loading: false }" @submit="loading = true">
                    <?php echo csrf_field(); ?>
                    ...
                    <div style="margin-bottom: 18px;">
                        ...
                        <div class="input-wrapper" style="position: relative;">
                            ...
                            <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>" required autofocus autocomplete="name" placeholder="Juan Dela Cruz" class="form-input">
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 18px;">
                        ...
                        <div class="input-wrapper" style="position: relative;">
                            ...
                            <input id="student_id" type="text" name="student_id" value="<?php echo e(old('student_id')); ?>" required placeholder="e.g. 2024-00001" class="form-input">
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 18px;">
                        ...
                        <div class="input-wrapper" style="position: relative;">
                            ...
                            <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="username" placeholder="name@email.com" class="form-input">
                        </div>
                    </div>
                ...
                <div style="text-align: center;">
                    <p style="font-size: 14px; color: #64748b; margin: 0;">
                        ...
                        <a href="<?php echo e(route('login')); ?>" style="color: #16a34a; text-decoration: none; font-weight: 600; transition: color 0.2s;" onmouseover="this.style.color='#15803d'" onmouseout="this.style.color='#16a34a'">
                            Sign in
                        </a>
                    </p>
                </div>
...
<?php /**PATH C:\Users\Cedric\SEIMS\resources\views/auth/register.blade.php ENDPATH**/ ?>