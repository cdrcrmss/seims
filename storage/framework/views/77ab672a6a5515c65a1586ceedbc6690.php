...
<head>
    ...
    <title><?php echo e(config('app.name', 'SEIMS')); ?> - <?php echo $__env->yieldContent('title', 'Laboratory Management'); ?></title>
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="flex items-center justify-between px-5 py-5 border-b border-white/10">
                <div class="flex items-center space-x-3">
                    <img src="<?php echo e(asset('images/spup_logo.png')); ?>" alt="SPUP Logo" class="w-9 h-9 object-contain rounded-lg bg-white/10 p-0.5">
            ...
            <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto sidebar-scroll">
                ...
                <a href="<?php echo e(route('dashboard')); ?>"
                   class="flex items-center px-3 py-2.5 rounded-xl text-sm <?php echo e(request()->routeIs('dashboard') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                ...
                <a href="<?php echo e(route('staff.borrowings.index')); ?>"
                   class="flex items-center px-3 py-2.5 rounded-xl text-sm <?php echo e(request()->routeIs('staff.borrowings.*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                ...
                <a href="<?php echo e(route('staff.borrow.form')); ?>"
                   class="flex items-center px-3 py-2.5 rounded-xl text-sm <?php echo e(request()->routeIs('staff.borrow.form') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                ...
                <a href="<?php echo e(route('student.borrow.form')); ?>"
                   class="flex items-center px-3 py-2.5 rounded-xl text-sm <?php echo e(request()->routeIs('student.borrow.form') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                    <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 11.5V14m0-2.5v-6a1.5 1.5 0 113 0m-3 6a1.5 1.5 0 00-3 0v2a7.5 7.5 0 0015 0v-5a1.5 1.5 0 00-3 0m-6-3V11m0-5.5v-1a1.5 1.5 0 013 0v1m0 0V11m0-5.5a1.5 1.5 0 013 0v3m0 0V11"></path></svg>
                    Borrow Items
                </a>
                <a href="<?php echo e(route('student.borrowings.index')); ?>"
                   class="flex items-center px-3 py-2.5 rounded-xl text-sm <?php echo e(request()->routeIs('student.borrowings.*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                    <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path></svg>
                    My Borrowings
                </a>
                <?php endif; ?>
                ...
                <a href="<?php echo e(route('reservations.index')); ?>"
                   class="flex items-center px-3 py-2.5 rounded-xl text-sm <?php echo e(request()->routeIs('reservations.*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                ...
                <a href="<?php echo e(route('maintenance.dashboard')); ?>"
                   class="flex items-center px-3 py-2.5 rounded-xl text-sm <?php echo e(request()->routeIs('maintenance.*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                ...
                <a href="<?php echo e(route('admin.users.index')); ?>"
                   class="flex items-center px-3 py-2.5 rounded-xl text-sm <?php echo e(request()->routeIs('admin.users.*') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                ...
                <a href="<?php echo e(route('admin.borrowings')); ?>"
                   class="flex items-center px-3 py-2.5 rounded-xl text-sm <?php echo e(request()->routeIs('admin.borrowings') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
                    <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                    All Borrowings
                </a>
                <a href="<?php echo e(route('admin.reports')); ?>"
                   class="flex items-center px-3 py-2.5 rounded-xl text-sm <?php echo e(request()->routeIs('admin.reports') ? 'sidebar-link-active' : 'sidebar-link'); ?>">
            ...
            <header class="flex-shrink-0 z-30 bg-white/80 backdrop-blur-xl border-b border-gray-100 shadow-sm">
                <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="text-lg font-semibold text-gray-800 font-poppins"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h2>
                    </div>
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div x-data="{ notifOpen: false }" class="relative">
                            ...
                            <div x-show="notifOpen" @click.away="notifOpen = false" x-cloak
                                ...
                                <div class="px-4 py-2 border-b border-gray-100 flex items-center justify-between">
                                    ...
                                    <?php if($unreadNotifCount > 0): ?>
                                    <span class="text-xs font-medium text-green-600 bg-green-50 px-2 py-0.5 rounded-full"><?php echo e($unreadNotifCount); ?> new</span>
                                    <?php endif; ?>
                                </div>
                                <div class="max-h-64 overflow-y-auto">
                                    <?php $__empty_1 = true; $__currentLoopData = $headerNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <a href="<?php echo e($notif->action_url ?? '#'); ?>" class="block px-4 py-3 hover:bg-gray-50 transition-colors <?php echo e(is_null($notif->read_at) ? 'bg-green-50/40' : ''); ?>">
                                        <div class="flex items-start space-x-3">
                                            <div class="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0
                                                <?php switch($notif->type ?? 'info'):
                                                    case ('success'): ?> bg-green-100 <?php break; ?>
                                                    <?php case ('warning'): ?> bg-yellow-100 <?php break; ?>
                                                    <?php case ('error'): ?> bg-red-100 <?php break; ?>
                                                    <?php default: ?> bg-blue-100
                                                <?php endswitch; ?>
                                            ">
                                                <?php switch($notif->type ?? 'info'):
                                                    case ('success'): ?>
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <p class="text-sm text-gray-900 <?php echo e(is_null($notif->read_at) ? 'font-semibold' : ''); ?>"><?php echo e($notif->title ?? $notif->message); ?></p>
                                                <?php if($notif->title && $notif->message): ?>
                                ...
                                <?php if($headerNotifications->count() > 0): ?>
                        ...
                        <div x-data="{ userOpen: false }" class="relative hidden sm:block">
                            <button @click="userOpen = !userOpen" class="flex items-center space-x-2 pl-2 border-l border-gray-200 cursor-pointer hover:bg-gray-50 rounded-lg pr-2 py-1 transition-colors">
                                ...
                                <span class="text-sm text-gray-700 font-medium hidden md:inline"><?php echo e(auth()->user()->name); ?></span>
                            ...
                            <div x-show="userOpen" @click.away="userOpen = false" x-cloak
                                ...
                                <div class="px-4 py-3 border-b border-gray-100">
                                    ...
                                    <span class="inline-block mt-1 px-2 py-0.5 text-xs font-medium bg-green-100 text-green-700 rounded-full capitalize"><?php echo e(auth()->user()->role); ?></span>
                                </div>
                                <a href="<?php echo e(route('profile')); ?>" class="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                                ...
                                <?php if(auth()->user()->isAdmin()): ?>
                                <a href="<?php echo e(route('admin.settings')); ?>" class="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
    ...
    <?php if(session('success')): ?>
        <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 4000)" x-cloak
            ...
            <div class="pointer-events-auto bg-white rounded-2xl shadow-2xl ring-1 ring-gray-100 p-6 text-center transform" style="width: 360px; max-width: 90vw;"
                ...
                <p class="text-sm text-gray-500"><?php echo e(session('success')); ?></p>
    ...
    <?php if(session('info')): ?>
        <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 4000)" x-cloak
            ...
            <div class="pointer-events-auto bg-white rounded-2xl shadow-2xl ring-1 ring-gray-100 p-6 text-center transform" style="width: 360px; max-width: 90vw;"
                ...
                <p class="text-sm text-gray-500"><?php echo e(session('info')); ?></p>
    ...
    <?php if(session('error')): ?>
        <div x-data="{ show: true }" x-show="show" x-cloak
            ...
            <div class="pointer-events-auto bg-white rounded-2xl shadow-2xl ring-1 ring-gray-100 p-6 text-center transform" style="width: 360px; max-width: 90vw;"
                ...
                <p class="text-sm text-gray-500"><?php echo e(session('error')); ?></p>
...
</html><?php /**PATH C:\Users\Cedric\SEIMS\resources\views/layouts/app.blade.php ENDPATH**/ ?>