...
<body>
    <div class="container">
        ...
        <div class="body">
            <p>Hello <strong><?php echo e($borrowing->user?->name ?? 'User'); ?></strong>,</p>
            ...
            <div class="detail-box">
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo e($borrowing->item?->name ?? 'N/A'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Quantity</span>
                    <span class="detail-value"><?php echo e($borrowing->quantity); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Return By</span>
                    <span class="detail-value"><?php echo e($borrowing->expected_return_date?->format('M d, Y') ?? 'N/A'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Approved On</span>
                    <span class="detail-value"><?php echo e($borrowing->approved_date?->format('M d, Y') ?? now()->format('M d, Y')); ?></span>
                </div>
            </div>
        ...
        <div class="footer">
            &copy; <?php echo e(date('Y')); ?> SEIMS — Supplies & Equipment Inventory Management System
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\Cedric\SEIMS\resources\views/emails/borrowing-approved.blade.php ENDPATH**/ ?>