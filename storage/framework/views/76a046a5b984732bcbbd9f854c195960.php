        ...
        <div class="glass rounded-2xl p-6 shadow-xl card-hover">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-green-600 dark:text-green-400 font-poppins"><?php echo e($roleCounts['total']); ?></p>
                </div>
        ...
        <div class="glass rounded-2xl p-6 shadow-xl card-hover">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-emerald-600 dark:text-emerald-400 font-poppins"><?php echo e($roleCounts['admin']); ?></p>
                </div>
        ...
        <div class="glass rounded-2xl p-6 shadow-xl card-hover">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-teal-600 dark:text-teal-400 font-poppins"><?php echo e($roleCounts['staff']); ?></p>
                </div>
        ...
        <div class="glass rounded-2xl p-6 shadow-xl card-hover">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-lime-600 dark:text-lime-400 font-poppins"><?php echo e($roleCounts['student']); ?></p>
                </div>
                        ...
                        <tr class="hover:bg-white/5 dark:hover:bg-white/5 transition-colors">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <?php if($user->student_id): ?>
                                            <div class="text-sm text-gray-500 dark:text-gray-400">ID: <?php echo e($user->student_id); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium 
                                    <?php echo e($user->role === 'admin' ? 'bg-purple-100 text-purple-800 dark:bg-purple-800/20 dark:text-purple-300' : 
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                <a href="<?php echo e(route('admin.users.edit', $user)); ?>" class="text-blue-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-300 transition-colors">
                                    Edit
                                </a>
                                <?php if($user->id !== auth()->id()): ?>
                                    <form action="<?php echo e(route('admin.users.delete', $user)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this user?')">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Cedric\innotrack\resources\views/admin/users/index.blade.php ENDPATH**/ ?>