...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Inventory Report -->
        <a href="<?php echo e(route('reports.inventory')); ?>" class="group bg-white rounded-2xl ring-1 ring-gray-200 shadow-sm p-6 hover:ring-blue-300 hover:shadow-md transition-all">
        ...
        <!-- Borrowing Report -->
        <a href="<?php echo e(route('reports.borrowing')); ?>" class="group bg-white rounded-2xl ring-1 ring-gray-200 shadow-sm p-6 hover:ring-green-300 hover:shadow-md transition-all">
        ...
        <!-- Maintenance Report -->
        <a href="<?php echo e(route('reports.maintenance')); ?>" class="group bg-white rounded-2xl ring-1 ring-gray-200 shadow-sm p-6 hover:ring-orange-300 hover:shadow-md transition-all">
        ...
        <!-- Reservation Report -->
        <a href="<?php echo e(route('reports.reservations')); ?>" class="group bg-white rounded-2xl ring-1 ring-gray-200 shadow-sm p-6 hover:ring-purple-300 hover:shadow-md transition-all">
        ...
        <a href="<?php echo e(route('reports.user-activity')); ?>" class="group bg-white rounded-2xl ring-1 ring-gray-200 shadow-sm p-6 hover:ring-red-300 hover:shadow-md transition-all">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Cedric\SEIMS\resources\views/reports/index.blade.php ENDPATH**/ ?>