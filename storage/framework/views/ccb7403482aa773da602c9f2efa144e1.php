...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex gap-3 pt-4 border-t border-gray-100">
                    ...
                    <a href="<?php echo e(route('reservations.index')); ?>" class="inline-flex items-center justify-center px-6 py-4 text-sm font-semibold text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 rounded-xl transition-all duration-200">
                        Cancel
                    </a>
                </div>
