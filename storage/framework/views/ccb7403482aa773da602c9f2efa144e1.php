        ...
        <div class="lg:col-span-1 space-y-3 animate-fade-in-up stagger-2">
            ...
            <div class="bg-white rounded-2xl ring-1 ring-gray-200 shadow-sm p-4">
                <div class="flex items-center justify-between mb-2.5">
                    ...
                    <span class="text-[10px] font-semibold <?php echo e($activeReservationCount >= 5 ? 'text-red-500' : 'text-green-600'); ?>"><?php echo e(5 - $activeReservationCount); ?> slot<?php echo e((5 - $activeReservationCount) !== 1 ? 's' : ''); ?> left</span>
                </div>
                <div class="flex items-baseline gap-1 mb-2">
                    <span class="text-2xl font-bold text-gray-900"><?php echo e($activeReservationCount); ?></span>
                    <span class="text-xs text-gray-400 font-medium">/ 5</span>
                </div>
                <div class="w-full bg-gray-100 rounded-full h-1.5">
                    <div class="h-1.5 rounded-full transition-all <?php echo e($activeReservationCount >= 5 ? 'bg-red-500' : ($activeReservationCount >= 3 ? 'bg-amber-500' : 'bg-green-500')); ?>" style="width: <?php echo e(min(($activeReservationCount / 5) * 100, 100)); ?>%"></div>
                </div>
            </div>
            ...
            <div class="bg-green-50 rounded-2xl ring-1 ring-green-100 p-4">
                ...
                <p class="text-[11px] text-gray-500 leading-relaxed">Use the <a href="<?php echo e(route('student.borrow.form')); ?>" class="text-green-600 font-semibold hover:underline">Borrow Items</a> page to request laboratory equipment separately.</p>
            </div>
        </div>
    </div>
</div>
