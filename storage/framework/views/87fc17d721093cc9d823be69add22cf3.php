<?php $__env->startSection('title', 'Borrow Items'); ?>
...
<div class="space-y-6" x-data="borrowForm()">
    ...
    <div class="flex items-center gap-4 animate-fade-in-up">
        <a href="<?php echo e(route('staff.borrowings.index')); ?>" class="p-2 rounded-xl hover:bg-gray-100 transition-colors">
            <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
        </a>
        <div>
            <h1 class="text-2xl font-bold text-gray-900 font-poppins">Borrow Items</h1>
            <p class="text-sm text-gray-500">Directly borrow items without approval</p>
        </div>
    </div>
        ...
        <div class="lg:col-span-3 space-y-4 animate-fade-in-up stagger-1">
            ...
            <div class="flex items-center justify-between px-1">
                ...
                <?php if($search || $category): ?>
                    <a href="<?php echo e(route('staff.borrow.form')); ?>" class="text-xs text-green-600 hover:text-green-700 font-semibold">Clear filters</a>
                <?php endif; ?>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div class="sm:col-span-2 bg-white rounded-xl ring-1 ring-gray-200 p-12 text-center">
                    ...
                    <?php if($search || $category): ?>
                        <a href="<?php echo e(route('staff.borrow.form')); ?>" class="inline-flex items-center gap-1 text-xs text-green-600 hover:text-green-700 font-semibold mt-3">
        ...
        <div class="lg:col-span-2 space-y-4 animate-fade-in-up stagger-2">
            ...
            <div class="bg-white rounded-2xl ring-1 ring-gray-200 shadow-sm sticky top-6 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 bg-gray-50/50">
                    <h2 class="text-base font-bold text-gray-900 font-poppins">Direct Borrowing</h2>
                    <p class="text-xs text-gray-500 mt-0.5">Select an item and borrow immediately</p>
                </div>

                <form method="POST" action="<?php echo e(route('staff.borrow')); ?>" @submit="handleSubmit($event)" class="p-6 space-y-5">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex gap-3 pt-1">
                        <button type="submit"
                                ...
                                :class="isSubmitting ? 'bg-gray-300 cursor-not-allowed' : 'bg-green-600 hover:bg-green-700 shadow-sm hover:shadow-md'"
                            ...
                            <span x-text="isSubmitting ? 'Processing...' : 'Borrow Item'"></span>
                        </button>
                        <a href="<?php echo e(route('staff.borrowings.index')); ?>" class="inline-flex items-center justify-center px-5 py-3 text-sm font-semibold text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 rounded-xl transition-colors">
                            Cancel
                        </a>
                    </div>

                    <p class="text-[10px] text-gray-400 text-center leading-relaxed">
                        By borrowing, you agree to return the item in good condition by the expected return date.
                    </p>
                </form>
            </div>
        </div>
...
function borrowForm() {
    return {
        ...
        async performSearch() {
            ...
            try {
                const response = await fetch('<?php echo e(route('staff.api.search-items')); ?>?q=' + encodeURIComponent(this.searchQuery));
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Cedric\SEIMS\resources\views/staff/borrowings/borrow.blade.php ENDPATH**/ ?>