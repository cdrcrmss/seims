...
<div class="space-y-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 animate-fade-in-up">
        ...
        <div class="flex space-x-3">
            <a href="<?php echo e(route('maintenance.index')); ?>" class="inline-flex items-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-700 px-5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"/></svg>
                View All Records
            </a>
            <form method="POST" action="<?php echo e(route('maintenance.generate-alerts')); ?>">
                <?php echo csrf_field(); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in-up stagger-1">
        <a href="<?php echo e(route('maintenance.index')); ?>" class="bg-white rounded-2xl ring-1 ring-gray-200 p-6 border-l-4 border-yellow-500 hover:ring-yellow-300 transition-all cursor-pointer block">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-yellow-600 mt-1 font-poppins"><?php echo e($upcomingMaintenance->count()); ?></p>
                </div>
        ...
        <a href="<?php echo e(route('maintenance.index')); ?>" class="bg-white rounded-2xl ring-1 ring-gray-200 p-6 border-l-4 border-red-500 hover:ring-red-300 transition-all cursor-pointer block">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Overdue</p>
                    <p class="text-3xl font-bold text-red-600 mt-1 font-poppins"><?php echo e($overdueMaintenance->count()); ?></p>
                </div>
        ...
        <a href="<?php echo e(route('staff.items.index')); ?>" class="bg-white rounded-2xl ring-1 ring-gray-200 p-6 border-l-4 border-orange-500 hover:ring-orange-300 transition-all cursor-pointer block">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Critical Items</p>
                    <p class="text-3xl font-bold text-orange-600 mt-1 font-poppins"><?php echo e($criticalItems->count()); ?></p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <!-- Overdue Maintenance -->
        <?php if($overdueMaintenance->count() > 0): ?>
        <div class="bg-white rounded-2xl ring-1 ring-red-200 shadow-sm p-6 animate-fade-in-up stagger-2">
            ...
            <div class="space-y-3">
                <?php $__currentLoopData = $overdueMaintenance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-center justify-between p-3 bg-red-50 rounded-xl">
                    <div>
                        <p class="font-medium text-gray-900"><?php echo e($record->item?->name ?? 'Unknown'); ?></p>
                        <p class="text-xs text-red-600">Due: <?php echo e($record->scheduled_date->format('M d, Y')); ?> (<?php echo e($record->scheduled_date->diffForHumans()); ?>)</p>
                    </div>
                    <span class="text-xs font-semibold px-2.5 py-1 bg-red-100 text-red-700 rounded-lg"><?php echo e(ucfirst($record->maintenance_type)); ?></span>
                </div>
        ...
        <div class="bg-white rounded-2xl ring-1 ring-gray-200 shadow-sm p-6 animate-fade-in-up stagger-2">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $upcomingMaintenance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl mb-2">
                <div>
                    <p class="font-medium text-gray-900"><?php echo e($record->item?->name ?? 'Unknown'); ?></p>
                    <p class="text-xs text-gray-500"><?php echo e($record->scheduled_date->format('M d, Y')); ?> · <?php echo e(ucfirst($record->maintenance_type)); ?></p>
                </div>
                <span class="text-xs text-gray-500"><?php echo e($record->scheduled_date->diffForHumans()); ?></span>
            </div>
        ...
        <div class="bg-white rounded-2xl ring-1 ring-gray-200 shadow-sm p-6 animate-fade-in-up stagger-3">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $criticalItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl mb-2">
                <div>
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <span class="text-sm font-bold text-red-600"><?php echo e($item->wear_level); ?>%</span>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="bg-white rounded-2xl ring-1 ring-gray-200 shadow-sm p-6 animate-fade-in-up stagger-3">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $recentlyCompleted; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl mb-2">
                <div>
                    <p class="font-medium text-gray-900"><?php echo e($record->item?->name ?? 'Unknown'); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Cedric\SEIMS\resources\views/maintenance/dashboard.blade.php ENDPATH**/ ?>