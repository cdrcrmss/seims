...
<?php $__env->startSection('title', 'Maintenance Predictions'); ?>
...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in-up stagger-1">
        ...
        <div class="bg-white rounded-2xl ring-1 ring-red-200 p-6 border-l-4 border-red-500">
            ...
            <p class="text-3xl font-bold text-red-600 mt-1 font-poppins"><?php echo e($critical); ?></p>
        ...
        <div class="bg-white rounded-2xl ring-1 ring-orange-200 p-6 border-l-4 border-orange-500">
            ...
            <p class="text-3xl font-bold text-orange-600 mt-1 font-poppins"><?php echo e($high); ?></p>
        ...
        <div class="bg-white rounded-2xl ring-1 ring-yellow-200 p-6 border-l-4 border-yellow-500">
            ...
            <p class="text-3xl font-bold text-yellow-600 mt-1 font-poppins"><?php echo e($moderate); ?></p>
    ...
    <div class="space-y-4 animate-fade-in-up stagger-2">
        <?php $__empty_1 = true; $__currentLoopData = $predictions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php
            $urgencyConfig = [
        ...
        ?>
        <div class="bg-white rounded-2xl ring-1 <?php echo e($config['ring']); ?> shadow-sm p-6 <?php echo e($config['border']); ?>">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div class="flex-1">
                    <div class="flex items-center space-x-3 mb-2">
                        <h3 class="text-lg font-semibold text-gray-900"><?php echo e($data['item']->name); ?></h3>
                        <span class="text-xs font-semibold px-2.5 py-1 rounded-lg <?php echo e($config['badge']); ?>">
                            <?php echo e(ucfirst($data['prediction']['urgency'])); ?>

                        </span>
                    </div>
                    <p class="text-sm text-gray-600"><?php echo e($data['item']->category); ?></p>
                    <p class="text-xs text-gray-500 mt-1"><?php echo e($data['prediction']['reasoning']); ?></p>
                </div>
                    ...
                    <div class="text-center">
                        ...
                        <div class="mt-1">
                            <div class="w-16 mx-auto bg-gray-200 rounded-full h-2">
                                <div class="h-2 rounded-full <?php echo e($config['wear']); ?>" style="width: <?php echo e($data['prediction']['current_wear_level']); ?>%"></div>
                            </div>
                            <p class="text-sm font-bold mt-1"><?php echo e($data['prediction']['current_wear_level']); ?>%</p>
                        </div>
                    </div>
                    <div class="text-center">
                        <p class="text-xs text-gray-500 uppercase">Wear Rate</p>
                        <p class="text-sm font-bold mt-1"><?php echo e($data['prediction']['average_wear_rate']); ?>/day</p>
                    </div>
                    <div class="text-center">
                        <p class="text-xs text-gray-500 uppercase">Days to Critical</p>
                        <p class="text-sm font-bold mt-1 <?php echo e($data['prediction']['days_until_critical'] <= 7 ? 'text-red-600' : 'text-gray-900'); ?>"><?php echo e($data['prediction']['days_until_critical']); ?></p>
                    </div>
                    <div class="text-center">
                        <p class="text-xs text-gray-500 uppercase">Next Maintenance</p>
                        <p class="text-sm font-bold mt-1"><?php echo e($data['prediction']['next_maintenance_date']->format('M d')); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Cedric\SEIMS\resources\views/analytics/maintenance-predictions.blade.php ENDPATH**/ ?>