...
<div class="space-y-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 animate-fade-in-up">
        <div>
            ...
            <p class="text-gray-600">Maintenance is scheduled automatically — view and complete records here</p>
        </div>
        <a href="{{ route('maintenance.dashboard') }}" class="inline-flex items-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-700 px-5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 shrink-0">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-gray-700">
                            ...
                            @elseif($record->status === 'scheduled' && $record->scheduled_date?->isToday())
                                <span class="text-yellow-600 text-xs font-semibold block">DUE TODAY</span>
                            @endif
                        </td>
                        <td class="px-6 py-4">
