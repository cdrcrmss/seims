    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div class="lg:col-span-3 space-y-4 animate-fade-in-up stagger-1">
            ...
            <div class="flex items-center justify-between px-1">
                ...
                @if($search || $category)
                    <a href="{{ route('staff.borrow.form') }}" class="text-xs text-green-600 hover:text-green-700 font-semibold">Clear filters</a>
                @endif
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div class="sm:col-span-2 bg-white rounded-xl ring-1 ring-gray-200 p-12 text-center">
                    ...
                    @if($search || $category)
                        <a href="{{ route('staff.borrow.form') }}" class="inline-flex items-center gap-1 text-xs text-green-600 hover:text-green-700 font-semibold mt-3">
        ...
        <div class="lg:col-span-2 space-y-4 animate-fade-in-up stagger-2">
            ...
            <div class="bg-white rounded-2xl ring-1 ring-gray-200 shadow-sm sticky top-6 overflow-hidden">
                ...
                <form method="POST" action="{{ route('staff.borrow') }}" @submit="handleSubmit($event)" class="p-6 space-y-5">
                    @csrf
                    ...
                    <div class="flex gap-3 pt-1">
                        ...
                        <a href="{{ route('staff.borrowings.index') }}" class="inline-flex items-center justify-center px-5 py-3 text-sm font-semibold text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 rounded-xl transition-colors">
                            Cancel
                        </a>
                    </div>
