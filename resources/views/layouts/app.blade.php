        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto sidebar-scroll">
                ...
                <a href="{{ route('staff.inbox') }}"
                   class="flex items-center px-3 py-2.5 rounded-xl text-sm {{ request()->routeIs('staff.inbox') ? 'sidebar-link-active' : 'sidebar-link' }}">
                ...
                <a href="{{ route('reports.index') }}"
                   class="flex items-center px-3 py-2.5 rounded-xl text-sm {{ request()->routeIs('reports.*') ? 'sidebar-link-active' : 'sidebar-link' }}">
