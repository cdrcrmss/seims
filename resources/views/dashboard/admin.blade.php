...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative flex items-center justify-between flex-wrap gap-4">
                ...
                <div class="flex items-center space-x-6 text-white">
                    <div class="text-right">
                        ...
                        <p class="text-xl font-semibold">{{ now()->format('g:i A') }}</p>
                    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="group relative overflow-hidden bg-gradient-to-br from-green-500 to-green-700 rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
            ...
            <div class="relative">
                ...
                <p class="text-5xl font-bold text-white mb-2">{{ $totalUsers }}</p>
        ...
        <div class="group relative overflow-hidden bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
            ...
            <div class="relative">
                ...
                <p class="text-5xl font-bold text-white mb-2">{{ $totalItems }}</p>
                <div class="flex items-center text-white/70 text-sm">
                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="group relative overflow-hidden bg-gradient-to-br from-emerald-600 to-green-700 rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
            ...
            <div class="relative">
                ...
                <p class="text-5xl font-bold text-white mb-2">{{ $totalBorrowings }}</p>
                <div class="flex items-center text-white/70 text-sm">
                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="group relative bg-gray-50 dark:bg-gray-700/50 hover:bg-green-50 dark:hover:bg-green-900/20 rounded-2xl p-5 transition-all duration-300 border border-gray-100 dark:border-transparent hover:border-green-200 dark:hover:border-green-700">
                                <div class="flex items-center justify-between gap-4">
                                    <div class="flex items-center space-x-4 flex-1">
                                        ...
                                        <div class="flex-1">
                                            <p class="font-bold text-lg text-gray-900 dark:text-white mb-1">{{ $activity->user->name }}</p>
                                            <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
                                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                                                </svg>
                                                <span>{{ $activity->item->name }} (Qty: {{ $activity->quantity }})</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3">
                                        @if($activity->status === 'pending')
                                            <form method="POST" action="{{ route('staff.borrowings.approve', $activity) }}" class="inline">
                                                @csrf
                                                @method('PATCH')
                                            ...
                                            <form method="POST" action="{{ route('staff.borrowings.reject', $activity) }}" class="inline">
                                                @csrf
                                                @method('PATCH')
                                        ...
                                        @else
                                            <span class="inline-flex items-center px-4 py-1.5 rounded-full text-sm font-bold shadow-lg
                                                {{ $activity->status === 'approved' ? 'bg-gradient-to-r from-blue-400 to-blue-600 text-white' : 
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <!-- User Management -->
            <a href="{{ route('admin.users.index') }}" class="group relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:border-green-300 dark:hover:border-green-600">
            ...
            <!-- System Settings -->
            <a href="{{ route('admin.settings') }}" class="group relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:border-green-300 dark:hover:border-green-600">
                <div class="absolute inset-0 bg-gradient-to-br from-green-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div class="relative">
                    <div class="flex items-center justify-between mb-4">
            ...
            <!-- System Reports -->
            <a href="{{ route('admin.reports') }}" class="group relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:border-green-300 dark:hover:border-green-600">
                <div class="absolute inset-0 bg-gradient-to-br from-green-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div class="relative">
                    <div class="flex items-center justify-between mb-4">
